...
const validateCorporationData = [
    body('corporationName').notEmpty().withMessage('Corporation name is required'),
        ...
        const mailOptions = {
          ...
          <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
            <p style="font-size: 16px;">Hi, ${req?.body?.adminName}</p>
             <p style="font-size: 12px;">You have been onboarded on the Oramsys platform. Click on the link below to rest your password.</p>
            <p style="font-size: 12px;">your current password is ${password}.</p>
            <p>
