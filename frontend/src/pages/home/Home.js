            ...
            <div>
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-center" style={contentStyle}>
                <div className="text-left mb-4 mb-md-0">
                  ...
                  <p>Oramsys is an STF(Structured Trade Finance) platform that is tailor-made to specfic client needs.</p>
                  <div>
            ...
            <div>
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-center" style={contentStyle}>
                <div className="text-left mb-4 mb-md-0">
                  ...
                  <p>This platform brings all the hassle of Structured trade under a single compact flow</p>
                  <div>
                    <a href="#" className="btn btn-danger mr-3">Read more<ArrowRightOutlined size={20} className='ml-2' /></a>
                    <a href="#" className="btn btn-secondary"><PlayCircleOutlined size={20} className='mr-2 font-bold' />Contact us</a>
                  </div>
            ...
            <div>
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-center" style={contentStyle}>
                <div className="text-left mb-4 mb-md-0">
                  ...
                  <h2>Who is it for?</h2>
                  <p>This is for banks and institutions that operate structured trade finance</p>
                  <div>
                    <a href="#" className="btn btn-danger mr-3">Read more<ArrowRightOutlined size={20} className='ml-2' /></a>
                    <a href="#" className="btn btn-secondary"><PlayCircleOutlined size={20} className='mr-2 font-bold' />Contact us</a>
                  </div>
            ...
            <div className="row pt-20">
              <div className="col-lg-4 col-md-6">
                <div className="financo-activities-box1">
                  ...
                  <h2 className="heading-title"><a href="#" className="text-decoration-none">4 Major banks onboarded</a></h2>
